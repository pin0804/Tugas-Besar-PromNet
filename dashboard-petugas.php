...
<head>
    ...
    <title>Dashboard &mdash; Data Petugas</title>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link active" href="dashboard-petugas.php"><i class="fa fa-fw fa-user-circle" aria-hidden="true"></i>Data Petugas</a>
                            </li>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered first">
                                    <thead>
                                        <tr class="hide_all">
                                            <form method="post" action="dashboard-petugas.php">
                                                <td colspan="2"></td>
                                                <td align="right">
                                        ...
                                        <tr class="hide_all">
                                            ...
                                            <td align="left" colspan="3">
                                                <a href="tambah-petugas.php"><i class="fas fa-plus-circle mr-2"></i>Tambah Data</a>&nbsp;&nbsp;
                                                <a href="dashboard-petugas.php" title="Refresh Table"><i class="fas fa-redo mr-2"></i>
                                                    Refresh Table</a>
                                            </td>
                                        </tr>
                                        <tr class="hide_all">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_POST['btn_cari'])) {
                                            if (!empty($_POST['txt_cari'])) {
                                                $cari = $_POST['txt_cari'];
                                                $sql = "SELECT * FROM tb_petugas WHERE nama LIKE '%" . $cari . "%' OR username LIKE '%" . $cari . "% '";
                                            } else {
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td align='center'><img src='images/petugas/" . $row['foto'] . "' width='150px'></td>";
    ...
    <div class="modal fade" id="examplePDF" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="#" class="btn btn-secondary" data-dismiss="modal">Batal</a>
                    <a href="pdf/petugas.php" class="btn btn-primary">Unduh</a>
                </div>
            </div>
        </div>
    </div>
