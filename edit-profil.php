...
<head>
    ...
    <title>Dashboard &mdash; Edit Profil</title>
...
<body>
                            ...
                            <div class="card-body">
                                <form id="validationform" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data">
                                    <div class="form-group row">
                                        <label class="col-12 col-sm-3 col-form-label text-sm-right">ID Petugas</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="text" disabled required="" class="form-control" name="txt_id_petugas" value="<?php echo $row_select['id_petugas']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-12 col-sm-3 col-form-label text-sm-right">Nama Petugas</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="text" required="" placeholder="Nama.." class="form-control" name="txt_nama_petugas" value="<?php echo $row_select['nama']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-12 col-sm-3 col-form-label text-sm-right">Username</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="text" required="" data-parsley-minlength="6" placeholder="Username.." class="form-control" name="txt_username" value="<?php echo $row_select['username']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-12 col-sm-3 col-form-label text-sm-right">Password</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="password" required="" data-parsley-maxlength="8" placeholder="Password.." class="form-control" name="txt_password" value="<?php echo $row_select['password']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-12 col-sm-3 col-form-label text-sm-right">Foto Profil</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <img src="images/petugas/<?php echo $row_select['foto']; ?>" height="100" width="100" />&nbsp;
                                            <input type="file" name="txt_file" value="<?php echo $row_select['foto']; ?>">
                                        </div>
                                    </div>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if (file_exists($nama_file)) {
                    ...
                    if ($_FILES['txt_file']['size'] < 500000) {
                        if ($imageFileType == 'jpg' || $imageFileType == 'png' || $imageFileType == 'jpeg' || $imageFileType == 'gif') {
                            unlink("images/petugas/" . $row_select['foto']);
        ...
        if (empty($nama_pErr) && empty($password_pErr) && empty($username_pErr) && empty($imageErr)) {
            //$id_data=$_POST['txt_id_petugas'];
            $sql_update = "UPDATE tb_petugas SET nama = '$nama_p', username = '$username_p', password = '$password_p'";

            if (!empty($_FILES['txt_file']['name'])) {
                $sql_update = $sql_update . ", foto='$image_name'";
            }
            $sql_update = $sql_update . " WHERE id_petugas = '$id_petugas'";
