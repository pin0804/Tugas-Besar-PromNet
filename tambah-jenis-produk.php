...
<head>
    ...
    <title>Dashboard &mdash; Tambah Jenis Produk</title>
...
<body>
    ...
    <div class="dashboard-main-wrapper">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Tambah Data Jenis Produk</h2>
                                ...
                                <form id="validationform" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="text" required="" placeholder="Nama.." class="form-control" name="txt_jenis_produk">
                                        </div>
                                    </div>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (!empty($nama)) {
                $sql_insert = "INSERT INTO tb_jenisproduk (nama_jenis) VALUE ('$nama')";
