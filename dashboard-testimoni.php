...
<head>
    ...
    <title>Dashboard &mdash; Data Testimoni</title>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered first">
                                    <thead>
                                        <tr class="hide_all">
                                            <form method="post" action="dashboard-testimoni.php">
                                                <td colspan="2"></td>
                                        ...
                                        <tr class="hide_all">
                                            ...
                                            <td align="left" colspan="3">
                                                <a href="tambah-testimoni.php"><i class="fas fa-plus-circle mr-2"></i>Tambah Data</a>&nbsp;&nbsp;
                                                <a href="dashboard-testimoni.php" title="Refresh Table"><i class="fas fa-redo mr-2"></i>
                                                    Refresh Table</a>
                                            </td>
                                        </tr>
                                        <tr class="hide_all">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_POST['btn_cari'])) {
                                            if (!empty($_POST['txt_cari'])) {
                                                $cari = $_POST['txt_cari'];
                                                $sql = "SELECT * FROM tb_testimoni t inner join tb_produk p on t.id_produk=p.id_produk inner join tb_jenisproduk j on p.id_jenisproduk=j.id_jenisproduk 
                                                            WHERE p.nama LIKE '%" . $cari . "%' 
                                                              OR j.nama_jenis LIKE '%" . $cari . "% '
                                                              OR t.nama_user LIKE '%" . $cari . "% '
                                                              OR t.rate LIKE '%" . $cari . "%'";
                                            } else {
                                                echo "<script>alert('Data Tersebut Tidak Ada !'); window.location='dashboard-testimoni.php';</script>";
                                            }
                                        } else {
                                            //Query SQL
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td width='200'>" . $row['nama_user'] . "</td>";
                                                echo "<td align='center'>" . $row['rate'] . "</td>";
                                                echo "<td align='center'>
                                                    <a href='detail-testimoni.php?detail_id=" . $row['id_testimoni'] . "' class='badge badge-pill badge-brand'>
                                                    Detail</a> &nbsp; &nbsp;";
                                                echo "<a href='edit-testimoni.php?update_id=" . $row['id_testimoni'] . "' class='badge badge-pill badge-edit'>
                                                    <i class='fas fa-edit'></i></a> &nbsp; &nbsp;";
                                                echo "<a href='hapus-testimoni.php?delete_id=" . $row['id_testimoni'] . "' class='badge badge-pill badge-delete' 
    ...
    <div class="modal fade" id="examplePDF" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="#" class="btn btn-secondary" data-dismiss="modal">Batal</a>
                    <a href="pdf/testimoni.php" class="btn btn-primary">Unduh</a>
                </div>
            </div>
        </div>
    </div>
