...
<head>
    ...
    <title>Dashboard &mdash; Tambah Testimoni</title>
    ...
    <div class="dashboard-main-wrapper">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Tambah Data Testimoni</h2>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="dashboard-produk.php">Data Testimoni</a></li>
                            ...
                            <div class="card-body">
                                <form id="validationform" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="text" required="" placeholder="Nama.." class="form-control" name="txt_nama_user">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <label class="custom-control custom-radio">
                                                <input type="radio" name="txt_rate" value="1" class="custom-control-input">
                                                <span class="custom-control-label">1</span>
                                            </label>
                                            <label class="custom-control custom-radio">
                                                <input type="radio" name="txt_rate" value="2" class="custom-control-input">
                                                <span class="custom-control-label">2</span>
                                            </label>
                                            <label class="custom-control custom-radio">
                                                <input type="radio" name="txt_rate" value="3" class="custom-control-input">
                                                <span class="custom-control-label">3</span>
                                            </label>
                                            <label class="custom-control custom-radio">
                                                <input type="radio" name="txt_rate" value="4" class="custom-control-input">
                                                <span class="custom-control-label">4</span>
                                            </label>
                                            <label class="custom-control custom-radio">
                                                <input type="radio" name="txt_rate" value="5" class="custom-control-input">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <textarea name="txt_test" required="" placeholder="Testimoni.." class="form-control" cols="30" rows="5"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-12 col-sm-3 col-form-label text-sm-right">Foto Pembeli</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="file" required="" name="txt_file">
                                        </div>
                                    </div>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (!empty($id_produk) && !empty($nama_user) && !empty($image_name) && !empty($testimoni) && !empty($rate)) {
                $sql_insert = "INSERT INTO tb_testimoni (id_produk, nama_user, foto_user, testimoni, rate) VALUE ('$id_produk', '$nama_user', '$image_name', '$testimoni', '$rate')";
