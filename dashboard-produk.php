...
<head>
    ...
    <title>Dashboard &mdash; Data Produk</title>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered first">
                                    <thead>
                                        <tr class="hide_all">
                                            <form method="post" action="dashboard-produk.php">
                                                <td colspan="3"></td>
                                        ...
                                        <tr class="hide_all">
                                            ...
                                            <td align="left" colspan="4">
                                                <a href="tambah-produk.php"><i class="fas fa-plus-circle mr-2"></i>Tambah Data</a>&nbsp;&nbsp;
                                                <a href="dashboard-produk.php" title="Refresh Table"><i class="fas fa-redo mr-2"></i>
                                                    Refresh Table</a>
                                            </td>
                                        </tr>
                                        <tr class="hide_all">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_POST['btn_cari'])) {
                                            if (!empty($_POST['txt_cari'])) {
                                                ...
                                                echo "<script>alert('Data Tersebut Tidak Ada !'); window.location='dashboard-produk.php';</script>";
                                            }
                                        } else {
                                            //Query SQL
                                            $sql = "SELECT * FROM tb_produk p inner join tb_jenisproduk j on p.id_jenisproduk=j.id_jenisproduk ";
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td align='center'>
                                                    <a href='detail-dashboard-produk.php?detail_id=" . $row['id_produk'] . "' class='badge badge-pill badge-brand'>
                                                    Detail</a> &nbsp; &nbsp;";
                                                echo "<a href='edit-produk.php?update_id=" . $row['id_produk'] . "' class='badge badge-pill badge-edit'>
                                                    <i class='fas fa-edit'></i></a> &nbsp; &nbsp;";
                                                echo "<a href='hapus-produk.php?delete_id=" . $row['id_produk'] . "' class='badge badge-pill badge-delete' 
    ...
    <div class="modal fade" id="examplePDF" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="#" class="btn btn-secondary" data-dismiss="modal">Batal</a>
                    <a href="pdf/produk.php" class="btn btn-primary">Unduh</a>
                </div>
            </div>
        </div>
    </div>
