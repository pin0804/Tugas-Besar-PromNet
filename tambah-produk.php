...
<head>
    ...
    <title>Dashboard &mdash; Tambah Produk</title>
    ...
    <div class="dashboard-main-wrapper">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Tambah Data Produk</h2>
                                ...
                                <form id="validationform" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="text" required="" placeholder="Nama.." class="form-control" name="txt_nama_produk">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="number" required="" placeholder="Harga.." class="form-control" name="txt_harga">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-12 col-sm-3 col-form-label text-sm-right">Stok</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="number" required="" placeholder="Stok.." class="form-control" name="txt_stok">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-12 col-sm-3 col-form-label text-sm-right">Keterangan Produk</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <textarea name="txt_ket" required="" placeholder="Keterangan.." class="form-control" cols="30" rows="5"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-12 col-sm-3 col-form-label text-sm-right">Foto Produk</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (!empty($nama) && !empty($id_jp) && !empty($harga) && !empty($stok) && !empty($ket) && !empty($image_name)) {
                $sql_insert = "INSERT INTO tb_produk (nama, id_jenisproduk, harga, stok, keterangan, foto) VALUE ('$nama', '$id_jp', '$harga', '$stok', '$ket', '$image_name')";
